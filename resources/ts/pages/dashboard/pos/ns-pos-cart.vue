                        ...
                        <tr class="success">
                            <td width="200" class="border p-2">
                                <template v-if="order && options.ns_pos_tax_type === 'exclusive'">
                                    <a v-if="options.ns_pos_price_with_tax === 'yes'" @click="openTaxSummary()" class="cursor-pointer outline-none border-dashed py-1 border-b border-info-primary text-sm">{{ __( 'Tax Included' ) }}: {{ nsCurrency( order.total_tax_value + order.products_exclusive_tax_value ) }}</a>
                        ...
                        <tr class="success">
                            <td width="200" class="border p-2">
                                <template v-if="order && options.ns_pos_tax_type === 'exclusive'">
                                    ...
                                    <a v-else-if="options.ns_pos_price_with_tax === 'no'" @click="openTaxSummary()" class="cursor-pointer outline-none border-dashed py-1 border-b border-info-primary text-sm">{{ __( 'Tax Inclusive' ) }}: {{ nsCurrency( order.total_tax_value + order.products_exclusive_tax_value ) }}</a>
                                </template>
                                <template v-else-if="order && options.ns_pos_tax_type === 'inclusive'">
                                    ...
                                    <a v-else-if="options.ns_pos_price_with_tax === 'no'" @click="openTaxSummary()" class="cursor-pointer outline-none border-dashed py-1 border-b border-info-primary text-sm">{{ __( 'Tax Included' ) }}: {{ nsCurrency( order.total_tax_value + order.products_exclusive_tax_value ) }}</a>
                                </template>
                            </td>
                            <td width="200" class="border p-2">
